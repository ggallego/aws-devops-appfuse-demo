...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.reinvent.service.impl.PasswordTokenManager#generateRecoveryToken(com.reinvent.model.User)
     */
    @Override
    ...
    /**
     * @see com.reinvent.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.reinvent.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.reinvent.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
