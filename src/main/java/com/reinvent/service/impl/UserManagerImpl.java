package com.reinvent.service.impl;

import org.apache.commons.lang.StringUtils;
import com.reinvent.dao.UserDao;
import com.reinvent.model.User;
import com.reinvent.service.MailEngine;
import com.reinvent.service.UserExistsException;
import com.reinvent.service.UserManager;
import com.reinvent.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.reinvent.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.reinvent.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
